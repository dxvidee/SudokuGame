  ...
  return (
    <nav className="w-full h-16 md:h-20 bg-[#e5e5e5] dark:bg-zinc-950 flex items-center justify-between px-4 md:px-12 transition-colors duration-300">
      ...
      <div className="flex items-center gap-4">
        <button className="w-11 h-11 rounded-xl bg-white dark:bg-zinc-800 flex items-center justify-center text-[#f0ad25] hover:bg-gray-50 dark:hover:bg-zinc-700 transition-colors shadow-sm">
